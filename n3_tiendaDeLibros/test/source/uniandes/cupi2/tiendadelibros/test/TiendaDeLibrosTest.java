...
public class TiendaDeLibrosTest
{
    ...
    public void testAbastecer( )
    {
        ...
        assertTrue( "No se abasteció correctamente", 50 == tiendaDeLibros.buscarLibroPorISBN( "AGHF324" ).darCantidadActual( ) );
    }
    ...
    public void testVender( )
    {
        ...
        assertEquals( "No se vendió correctamente", 30, tiendaDeLibros.buscarLibroPorISBN( "AGHF324" ).darCantidadActual( ) );
        boolean venta = tiendaDeLibros.vender( "AGHF324", 31, fecha.toGMTString( ) );
