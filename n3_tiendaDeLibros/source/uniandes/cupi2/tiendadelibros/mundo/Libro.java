...
public class Libro
{
    ...
    public Libro( String pTitulo, String pIsbn, double pPrecioVenta, double pPrecioCompra, String pRutaImagen )
    {
        ...
        VectorComentario = new ArrayList<Comentario>( );
    ...
    public void comentario( String pContenido,int pCalificacion,Cliente pCliente2 )
    {
        Comentario nuevoComentario = new Comentario( pContenido, pCalificacion,pCliente2 );
    	VectorComentario.add( nuevoComentario );

    }
    //retornar comentarios
    
    public ArrayList<Comentario> VectorComentario( )
    {
        return VectorComentario;
    }
